...
export default {
  ...
  "variants": {
    "color": {
      ...
      "important": {
        "base": "border border-important/25 bg-important/10 text-important-600 dark:text-important-300 [&_a]:text-important [&_a]:hover:border-important [&_a]:focus-visible:outline-important [&_code]:text-important-600 dark:[&_code]:text-important-300 [&_code]:border-important/25 [&_a]:hover:[&>code]:border-important [&_a]:hover:[&>code]:text-important [&_a]:focus-visible:[&>code]:border-important [&_a]:focus-visible:[&>code]:text-important [&>ul]:marker:text-important/50",
        "icon": "text-important",
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "to": true,
      "class": {
        "base": "hover:border-important has-focus-visible:border-important",
