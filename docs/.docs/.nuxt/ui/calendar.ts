...
export default {
  ...
  "variants": {
    "color": {
      ...
      "important": {
        ...
        "cellTrigger": "focus-visible:ring-important"
      },
      "neutral": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": {
        "cellTrigger": "data-[selected]:bg-important data-[selected]:text-inverted data-today:not-data-[selected]:text-important data-[highlighted]:bg-important/20 hover:not-data-[selected]:bg-important/20"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "cellTrigger": "data-[selected]:ring data-[selected]:ring-inset data-[selected]:ring-important/50 data-[selected]:text-important data-today:not-data-[selected]:text-important data-[highlighted]:bg-important/10 hover:not-data-[selected]:bg-important/10"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "soft" as typeof variant[number],
      "class": {
        "cellTrigger": "data-[selected]:bg-important/10 data-[selected]:text-important data-today:not-data-[selected]:text-important data-[highlighted]:bg-important/20 hover:not-data-[selected]:bg-important/20"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "cellTrigger": "data-[selected]:bg-important/10 data-[selected]:text-important data-[selected]:ring data-[selected]:ring-inset data-[selected]:ring-important/25 data-today:not-data-[selected]:text-important data-[highlighted]:bg-important/20 hover:not-data-[selected]:bg-important/20"
      }
    },
    {
